...
//       final index = volunteerController.volunteersList.indexWhere(
...
//       if (index != -1) {
//         volunteerController.volunteersList[index] = updatedData;
//       } else {
//         volunteerController.volunteersList.add(updatedData);
//       }
...
//       volunteerController.volunteersList.refresh();
...
//       final exists = volunteerController.volunteersList.any(
...
//       volunteerController.volunteersList.add(newData);
